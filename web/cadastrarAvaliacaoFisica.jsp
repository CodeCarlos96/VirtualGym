...
<html>
    <head>
        ...
        <title>Virtual Gym - Cadastrar Avaliação Fisica</title>
    </head>
    <body>
        ...
        <form action="ManterAvaliacaoFisicaController?acao=confirmarOperacao&operacao=${operacao}&idAvaliacaoFisica=${avaliacaoFisica.idAvaliacaoFisica}" method="post" name="formManterAvaliacaoFisica" onsubmit="return validarFormulario(this)">
                    ...
                    <td>
                        <select name="optProfessor" <c:if test="${operacao == 'Excluir'}"> disabled </c:if>>
                            ...
                            <c:forEach items="${professores}" var="professor">
                                <option value="${professor.idProfessor}" <c:if test="${avaliacaoFisica.professor.idProfessor == professor.idProfessor}"> selected </c:if>>${professor.usuario.nome}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
                    ...
                    <td>
                        <select name="optAluno" <c:if test="${operacao == 'Excluir'}"> disabled </c:if>>
                            ...
                            <c:forEach items="${alunos}" var="aluno">
                                <option value="${aluno.idAluno}" <c:if test="${avaliacaoFisica.aluno.idAluno == aluno.idAluno}"> selected </c:if>>${aluno.usuario.nome}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
