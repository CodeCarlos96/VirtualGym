...
<html>
    <head>
        ...
        <title>Virtual Gym - Cadastrar Sala</title>
    </head>
    <body>
        <a href="index.jsp"><button>Menu</button></a>
        <a href="PesquisaSalaController"><button>Voltar</button></a>
        <h1>${operacao} Sala</h1>
        <form action="ManterSalaController?acao=confirmarOperacao&operacao=${operacao}&idSala=${sala.idSala}" method="post" name="formManterSala" onsubmit="return validarFormulario(this)">
